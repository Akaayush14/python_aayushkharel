...
#21
total_days = int(input("Enter the total number of class days: "))
absent_days = int(input("Enter the total number of your absent days: "))

present_days = total_days - absent_days
present_per= (present_days / total_days) * 100
print(f"You have attended {present_per:.2f}% of your daily class")
if present_per < 75:
